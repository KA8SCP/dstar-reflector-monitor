...
function card(r){
 ...
 <section><h3>Service</h3><div class="servicegrid"><div class="serviceitem"><span class="label">Uptime</span><span class="value">${esc(r.uptime||'Not published')}</span></div><div class="serviceitem"><span class="label">Software / Dashboard</span><span class="value">${esc(r.version||'Not published')}</span></div></div></section>
